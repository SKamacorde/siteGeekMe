 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/asus"><img src="build/assets3/img/fabricantes/ASUS.png" class="img-menu"></a>
      </div>
...
<body class="animsition">
	...
	<section class="bg0 p-t-23 p-b-140">
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".computador">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componente">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/3060Ti.png" alt="IMG-PRODUCT">

							<a href="/rtx3060" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Asus GeForce® RTX 3060 Ti DUAL OC 8GB - 90YV0IP0-M0NA00
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componente">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-MotherboardTuf.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Motherboard Asus Motherboard ATX TUF Gaming H770-Pro WiFi
								</a>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item computador">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-Rog.png" alt="IMG-PRODUCT">

							<a href="/pc-asus-rog" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Asus ROG Ryzen 7 5800X 32GB 1TB SSD RTX 3070 W11H
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item monitor">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-MonitorTufg.png" alt="IMG-PRODUCT">

							<a href="/asus-monitor24" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Monitor Asus 24" TUF FHD 270Hz 1ms ELMB FreeSync 2x2W Gaming - VG249QM1A
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item monitor">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-MonitorProArt.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Monitor Asus 27" ProArt PA278QV IPS WQHD
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item monitor">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-MonitorPortatil.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Monitor Asus ZenScreen MB165B 15.6" LED WSXGA Monitor USB Portátil
								</a>
