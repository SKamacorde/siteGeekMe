 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/portatil"><img src="build/assets3/img/menu/PORTATIL.png" class="img-menu"></a>
      </div>
...
<body class="animsition">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".intel">
						Intel
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".amd">
						AMD
					</button>
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".lenovo">
						Lenovo
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".dell">
						Dell
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".asus">
						Asus
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".msi">
						MSI
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".gigabyte">
						Gigabyte
					</button>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item apple">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Apple-MacbookAir13_3.png" alt="IMG-PRODUCT">

							<a href="/macbook-air" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								Apple MacBook Air 13.3" Apple M1 8GB 256GB SSD
								</a>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item lenovo amd">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-ideapadg3.png" alt="IMG-PRODUCT">

							<a href="/ideapad-gaming3" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Lenovo IdeaPad Gaming 3 15ACH06 
								</a>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item dell intel">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Dell-Latitude3420.png" alt="IMG-PRODUCT">

							<a href="/dell-latitude" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item msi intel">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item apple">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Apple-MacbookPro14.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Apple MacBook Pro 14.2" M2 Pro CPU 10-core, GPU 16-core SSD 512GB 16GB RAM
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item gigabyte intel">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item lenovo amd">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-Ideapad1.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Lenovo Ideapad 1 14ADA7 (14'' Amd 3020e 12 GB 64 GB Emmc Amd Radeon Graphics)
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item lenovo amd">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-Legion5.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Lenovo Legion 5 15ACH6H-289 15.6" FHD Ryzen 5 5600H 8GB 512GB SSD RTX 3060 
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item gigabyte intel">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Computador Portátil AORUS 5 SE4-73PT213SH | 15.6'' | Intel® Core i7-12700H | GeForce RTX 3060 | 16 GB | SSD 512GB
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item asus amd">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Asus-RogStrix.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Portátil Asus ROG Strix G15 15.6" G513IE-R74BRT5PS2
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item dell amd">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Dell-Vostro.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item gigabyte intel">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								GIGABYTE AERO 16 XE5-73PT738HP 
								</a>
