    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Produtos Logitech</h1>
        </div>
        <a href="/logitech"><img src="build/assets3/img/fabricantes/LOGITECH.png" class="img-menu"></a>
      </div>
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".rato">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item rato">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/HP-Teclado230.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Teclado Mecânico Logitech G413 Carbon PT Romer-G
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Logitech-TecladoMX.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Teclado Logitech MX Keys Mini Bluetooth US Graphite
								</a>
