    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Produtos Kingston</h1>
        </div>
        <a href="/kingston"><img src="build/assets3/img/fabricantes/KINGSTON.png" class="img-menu"></a>
      </div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ram">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/16RAM_Gigabyte_.png" alt="IMG-PRODUCT">

							<a href="/kingston-16gb-ram" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								Memória RAM Kingston 16GB Fury Beast 2x8GB DDR4 3200MHz CL16 - KF432C16BBK2/16
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ssd">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Kingston-SSD240gb.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Kingston 240GB SSD A400 2.5 SATA III - SA400S37/240G
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ssd">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Kingston 480GB A400 2.5" SATA III TLC SSD - SA400S37/480G
								</a>
