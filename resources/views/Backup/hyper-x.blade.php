    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Produtos HyperX</h1>
        </div>
        <a href="/hyper-x"><img src="build/assets3/img/fabricantes/HYPER-X.png" class="img-menu"></a>
      </div>
...
<body class="animsition">
	...
	<section class="bg0 p-t-23 p-b-140">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/HyperX-Teclado.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								HyperX Alloy Origins Core RGB (USB - Português - Mecânico) - 0196188487358
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item componente">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/HyperXKingston-RAM.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Memória RAM Kingston 32GB Fury Impact (2x 16GB) 3200Mhz SODimm DDR4 CL20 1Rx8 - KF432S20IBK2/32
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/HyperX-TecladoAlloy.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Teclado HyperX Alloy Core RGB PT-BR
								</a>
