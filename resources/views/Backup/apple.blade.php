 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/apple"><img src="build/assets3/img/fabricantes/APPLE.png" class="img-menu"></a>
      </div>
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".portatil">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Apple-Teclado.png" alt="IMG-PRODUCT">

							<a href="/apple-teclado" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Ver Mais
							</a>
						</div>
