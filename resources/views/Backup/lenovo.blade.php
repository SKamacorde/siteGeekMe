    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Produtos Lenovo</h1>
        </div>
        <a href="/lenovo"><img src="build/assets3/img/fabricantes/LENOVO.png" class="img-menu"></a>
      </div>
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".computador">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".teclado">
						Teclado
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".rato">
						Rato
					</button>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item lenovo computador">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-LegionT5.png" alt="IMG-PRODUCT">

							<a href="/lenovo-legion-t5" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item lenovo portatil">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item rato">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item monitor">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-MonitorG24e.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Monitor Lenovo 23.8" G24e-20 VA FHD 120Hz FreeSync - 66D7GAR1EU
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item teclado">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-Teclado.png" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item monitor">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/Lenovo-Monitor27.png" alt="IMG-PRODUCT">

							<a href="/lenovo-monitor27" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								Monitor Lenovo 27" G27-30 1 ms 165 Hz AMD Radeon FreeSync Premium
								</a>
