 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/Drama"><img src="build/assets3/img/clients/Sem_fundo/Universo_geek.png" class="img-menu"></a>
      </div>
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/o_menino_do_pijama_listrado" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
