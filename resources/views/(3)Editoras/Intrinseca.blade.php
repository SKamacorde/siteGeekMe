 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/Drama"><img src="build/assets3/img/clients/Sem_fundo/Intrínseca.png" class="img-menu"></a>
      </div>
			...
			<div class="row isotope-grid">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/como_eu_era_antes_de_voce" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item processador">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/a_culpa_e_das_estrelas" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/os_diarios_do_semideus" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item computador">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/Livros/PercyJacksonoLadraodeRaios.png" alt="IMG-PRODUCT">

							<a href="/Percy_Jackson_o_Ladrao_de_Raios"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/Percy_Jackson_o_Ladrao_de_Raios" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
