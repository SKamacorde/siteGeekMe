 ...
 <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="/Drama"><img src="build/assets3/img/clients/Sem_fundo/VReditora.png" class="img-menu"></a>
      </div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item processador">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/diario_de_banana_rodrik_e_cara" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/DiarioDeUmBanana3.png" alt="IMG-PRODUCT">

							<a href="/diario_de_um_banana_3"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/diario_de_um_banana_3" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item computador">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/DiarioDeUmBanana4.png" alt="IMG-PRODUCT">

							<a href="/diario_de_um_banana_4"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/diario_de_um_banana_4" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item computador">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/DiarioDeUmBanana5.png" alt="IMG-PRODUCT">

							<a href="/diario_de_um_banana_5"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/diario_de_um_banana_5" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item computador">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/DiarioDeUmBanana6.png" alt="IMG-PRODUCT">

							<a href="/diario_de_um_banana_6"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/diario_de_um_banana_6" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
