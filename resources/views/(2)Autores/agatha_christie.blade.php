		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item processador">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/AssasinatonoExpressodoOriente.png" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/Assasinato_no_expresso_do_oriente" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item portatil">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="build/assets2/images/produtos/OAssasinatodeRogerAckroyd.png" alt="IMG-PRODUCT">

							<a href="/o_assasinato_de_roger_ackroyd"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Ver Mais
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/o_assasinato_de_roger_ackroyd" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									O Assasinato de Roger Ackroyd
								</a>
							</div>
